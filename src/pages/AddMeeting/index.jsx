            ...
            <div className="flex flex-col gap-[13px]">
              <div className="flex p-[20px] sm:p-5 bg-gray-100_01 rounded-[20px] mt-[10px]">
                <div className="flex justify-between w-full gap-10">
                  <div className="flex flex-col w-[70%] gap-[22px]">
                    ...
                    <div className="flex justify-center items-center gap-[117px]">
                      <Text as="p" className="w-[30px]">Course Name</Text>
                      <select name="Course Name" className=" p-[10px] flex-1 bg-white-A700_01">
                        <option value=""></option>
                    ...
                    <div className="flex justify-center items-center gap-[117px]">
                      <Text as="p" className="w-[30px]">Room Name</Text>
                      <select name="Room Name" className=" p-[10px] flex-1 bg-white-A700_01">
                        <option value=""></option>
